   ...
   public class ResizableAssetControl extends AbstractAssetControlDecorator
   {
      ...
      private function updatePoints() : void
      {
         ...
         if(super.asset is IResizable)
         {
            ...
            UIComponent(this._points["topLeft"]).x = -_loc2_ / 2 - super.borderWidth / 2;
            UIComponent(this._points["topLeft"]).y = -_loc3_ / 2 - super.borderWidth / 2;
            UIComponent(this._points["topRight"]).x = _loc2_ / 2 + super.borderWidth / 2;
            UIComponent(this._points["topRight"]).y = -_loc3_ / 2 - super.borderWidth / 2;
            UIComponent(this._points["bottomRight"]).x = _loc2_ / 2 + super.borderWidth / 2;
            UIComponent(this._points["bottomRight"]).y = _loc3_ / 2 + super.borderWidth / 2;
            UIComponent(this._points["bottomLeft"]).x = -_loc2_ / 2 - super.borderWidth / 2;
            UIComponent(this._points["bottomLeft"]).y = _loc3_ / 2 + super.borderWidth / 2;
         }
      }
