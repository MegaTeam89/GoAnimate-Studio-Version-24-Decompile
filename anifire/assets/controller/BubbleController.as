package anifire.assets.controller
{
   ...
   public class BubbleController extends AbstractAssetController implements IResizable, IMovable, IBubbleTail, IRotatable
   {
      ...
      public function get tailX() : Number
      {
         ...
         if(asset is IBubbleTail)
         {
            if(view.assetImage is IAssetImage)
            {
               _loc1_ = IAssetImage(view.assetImage).rect;
      ...
      public function set tailX(param1:Number) : void
      {
         ...
         if(view.assetImage is IAssetImage)
         {
            _loc2_ = IAssetImage(view.assetImage).rect;
            if(_loc2_)
            {
               param1 += _loc2_.x + _loc2_.width / 2;
            }
         }
         if(asset is IBubbleTail)
         {
      ...
      public function set tailY(param1:Number) : void
      {
         ...
         if(view.assetImage is IAssetImage)
         {
            ...
            if(_loc2_)
            {
               param1 += _loc2_.y + _loc2_.height / 2;
            }
         }
         if(asset is IBubbleTail)
         {
      ...
      public function set width(param1:Number) : void
      {
         ...
         if(param1 != this.width)
         {
            ...
            if(view.assetImage is IAssetImage)
            {
               ...
               _loc4_ = IAssetImage(view.assetImage).rect.clone();
               if(asset is BubbleAsset)
               {
                  if((_loc5_ = asset as BubbleAsset).isShadow)
                  {
                  ...
                  else
                  {
                     ...
                     if(_loc4_)
                     {
                        _loc4_.x += (_loc4_.width - param1) / 2;
                        _loc4_.y += (_loc4_.height - this.height) / 2;
                        _loc4_.width = param1;
            ...
            if(view.assetImage is IAssetImage)
            {
               ...
               if(asset is BubbleAsset)
               {
                  ...
                  else
                  {
                     ...
                     if(_loc4_)
                     {
                        _loc4_.x += (_loc4_.width - this.width) / 2;
                        _loc4_.y += (_loc4_.height - param1) / 2;
      ...
      public function resize(param1:Number, param2:Number, param3:Boolean = false) : void
      {
         ...
         if(param1 != this.width || param2 != this.height)
         {
            ...
            if(view.assetImage is IAssetImage)
            {
               ...
               _loc6_ = IAssetImage(view.assetImage).rect.clone();
               if(asset is BubbleAsset)
               {
                  if((_loc7_ = asset as BubbleAsset).isShadow)
                  {
                  ...
                  else
                  {
                     ...
                     if(_loc6_)
                     {
                        _loc6_.x += (_loc6_.width - param1) / 2;
                        _loc6_.y += (_loc6_.height - param2) / 2;
                        _loc6_.width = param1;
