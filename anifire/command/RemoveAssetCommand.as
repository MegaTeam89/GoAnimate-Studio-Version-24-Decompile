package anifire.command
{
   ...
   public class RemoveAssetCommand extends SuperCommand
   {
      ...
      public function RemoveAssetCommand(param1:AnimeSound = null, param2:String = "")
      {
         super();
         this._charId = param2;
         this._sound = param1;
      ...
      override public function undo() : void
      {
         ...
         if(this._sound != null)
         {
            ...
            Console.getConsole().speechManager.ttsManager.addSoundBySound(this._sound);
      ...
      override public function redo() : void
      {
         ...
         if(this._sound != null)
         {
            ...
            Console.getConsole().speechManager.ttsManager.removeSoundById(this._sound.getID());
            Console.getConsole().currentScene.refreshEffectTray();
         }
      }
   }
