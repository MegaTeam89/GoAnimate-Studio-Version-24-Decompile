      ...
      public function init(param1:XML, param2:UtilHashBytes, param3:UtilHashBytes = null, param4:int = 1, param5:ByteArray = null) : void
      {
         ...
         switch(param4)
         {
            case RaceConstants.CUSTOM_CHARACTER:
               (_loc6_ = new CustomCharacterMaker()).addEventListener(LoadEmbedMovieEvent.COMPLETE_EVENT,this.initCCMakerComplete);
               _loc6_.initBySwfs(param1,param2,param3);
               break;
            case RaceConstants.SKINNED_SWF:
               (_loc7_ = new SkinnedCharacterMaker()).addEventListener(LoadEmbedMovieEvent.COMPLETE_EVENT,this.initCCMakerComplete);
