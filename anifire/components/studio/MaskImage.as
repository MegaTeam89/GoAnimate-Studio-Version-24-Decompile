package anifire.components.studio
{
   ...
   public class MaskImage extends TitleWindow implements IBindingClient
   {
      ...
      private var _464626725_stepCan:VBox;
      ...
      public function MaskImage()
      {
         ...
         this._documentDescriptor_ = new UIComponentDescriptor({
            "type":TitleWindow,
            "events":{
               "mouseUp":"___MaskImage_TitleWindow1_mouseUp",
               "creationComplete":"___MaskImage_TitleWindow1_creationComplete"
            },
         ...
         this.addEventListener("creationComplete",this.___MaskImage_TitleWindow1_creationComplete);
         var i:uint = 0;
      ...
      {
         this._stepCan.validateDisplayList();
         this._stepCan.validateNow();
         this.goStep1();
      }
      ...
      private function doMoveImage(param1:Event) : void
      {
         ...
         this.myImageCan.x += _loc2_;
         this.myImageCan.y += _loc3_;
         this.synShadowImage();
      }
      ...
      public function save(param1:Event = null) : void
      {
         ...
         var _loc2_:Number = 1 / this.myImageCan.scaleX;
         var _loc3_:Number = 0;
         while(_loc3_ < this.num_pt)
         {
            this.pts[_loc3_].visible = false;
            _loc3_++;
         }
         this.maskArray[1].visible = false;
         var _loc4_:Number = (this._maxx - this._minx) * _loc2_;
         var _loc5_:Number = (this._maxy - this._miny) * _loc2_;
         var _loc6_:BitmapData = new BitmapData(_loc4_,_loc5_,true,0);
         var _loc7_:Rectangle = new Rectangle(0,0,_loc4_,_loc5_);
         this.refCan.visible = false;
         this.shadowImageCan.visible = false;
         var _loc8_:Matrix = new Matrix(_loc2_,0,0,_loc2_,-this._minx * _loc2_,-this._miny * _loc2_);
         _loc6_.draw(this.myCan,_loc8_,null,null,_loc7_,true);
         var _loc9_:PNGEncoder;
         var _loc10_:ByteArray = (_loc9_ = new PNGEncoder()).encode(_loc6_);
         var _loc11_:Base64Encoder;
         (_loc11_ = new Base64Encoder()).encodeBytes(_loc10_);
         var _loc13_:URLVariables = new URLVariables();
         Util.addFlashVarsToURLvar(_loc13_);
         _loc12_ = new URLRequest(ServerConstants.ACTION_UPDATE_PROP);
         _loc13_[ServerConstants.PARAM_ASSET_ID] = this.assetId;
         _loc13_["shiftx"] = -1 * (this.refCan.x - this._minx) * _loc2_;
         _loc13_["shifty"] = -1 * (this.refCan.y - 30 - this._miny) * _loc2_;
         _loc13_["scale"] = _loc2_;
         _loc13_["imageData"] = _loc11_.flush();
         _loc12_.data = _loc13_;
         _loc12_.method = URLRequestMethod.POST;
         var _loc14_:URLStream;
         (_loc14_ = new URLStream()).addEventListener(Event.COMPLETE,this.onUploadCustomAssetCompleteData);
         _loc14_.addEventListener(IOErrorEvent.IO_ERROR,this.onUploadCustomAssetCompleteData);
         _loc14_.addEventListener(SecurityErrorEvent.SECURITY_ERROR,this.onUploadCustomAssetCompleteData);
         _loc14_.load(_loc12_);
      }
      ...
      private function showPoints(param1:Event) : void
      {
         ...
         while(_loc3_ < this.num_pt)
         {
            _loc2_ += "var pt" + (_loc3_ + 1) + ":Point = new Point(" + Util.roundNum(this.pts[_loc3_].x) + "," + Util.roundNum(this.pts[_loc3_].y) + ");\n";
            _loc3_++;
         }
      }
      ...
      private function onMouseMove(param1:Event) : void
      {
         ...
         if(this._currDraggingSprite == this._canRotate)
         {
            ...
            this._canRotate.rotation = Math.round(_loc4_ * 180 / Math.PI);
            if(this.myImageCan.rotation != this._canRotate.rotation)
            {
               this.changeRotate();
            }
         }
      ...
      private function initPosition() : void
      {
         ...
         this.btnFlipY.x += this.btnFlipY.height + 10;
      }
      ...
      private function _MaskImage_RadioButtonGroup1_i() : RadioButtonGroup
      {
         ...
         BindingManager.executeBindings(this,"lineType",this.lineType);
         return _loc1_;
      }
      ...
      public function ___MaskImage_TitleWindow1_creationComplete(param1:FlexEvent) : void
      {
         this.init();
      }
      ...
      [Bindable(event="propertyChange")]
      public function get _stepCan() : VBox
      {
         return this._464626725_stepCan;
      }
      
      public function set _stepCan(param1:VBox) : void
      {
         var _loc2_:Object = this._464626725_stepCan;
         if(_loc2_ !== param1)
         {
            this._464626725_stepCan = param1;
            if(this.hasEventListener("propertyChange"))
            {
               this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this,"_stepCan",_loc2_,param1));
            }
         }
      }
      ...
      {
         var _loc2_:Object = this._57826838btnUnCropImage;
         if(_loc2_ !== param1)
         {
      ...
      {
         var _loc2_:Object = this._2128854107btnUnLockImage;
         if(_loc2_ !== param1)
         {
      ...
      {
         var _loc2_:Object = this._3194991hand;
         if(_loc2_ !== param1)
         {
      ...
      {
         var _loc2_:Object = this._1188665678lineType;
         if(_loc2_ !== param1)
         {
      ...
      {
         var _loc2_:Object = this._1023330954myBackgroundCan;
         if(_loc2_ !== param1)
         {
      ...
      {
         var _loc2_:Object = this._104336004myCan;
         if(_loc2_ !== param1)
         {
      ...
      {
         var _loc2_:Object = this._1238661901myImageBackgroundCan;
         if(_loc2_ !== param1)
         {
      ...
      {
         var _loc2_:Object = this._398777791myImageCan;
         if(_loc2_ !== param1)
         {
      ...
      {
         var _loc2_:Object = this._466094112pointCan;
         if(_loc2_ !== param1)
         {
      ...
      {
         var _loc2_:Object = this._934862275refCan;
         if(_loc2_ !== param1)
         {
      ...
      {
         var _loc2_:Object = this._216437328scaleDownBtn;
         if(_loc2_ !== param1)
         {
      ...
      {
         var _loc2_:Object = this._1914892951scaleUpBtn;
         if(_loc2_ !== param1)
         {
      ...
      {
         var _loc2_:Object = this._660568935shadowImageBackgroundCan;
         if(_loc2_ !== param1)
         {
      ...
      {
         var _loc2_:Object = this._398907829shadowImageCan;
         if(_loc2_ !== param1)
         {
