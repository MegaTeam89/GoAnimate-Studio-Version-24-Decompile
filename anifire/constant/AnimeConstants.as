package anifire.constant
{
   ...
   public class AnimeConstants
   {
      ...
      public static const ZOOM_DURATION:Number = 0.5;
      
      public static const AUTOSAVE_INTERVAL:Number = 10 * 60 * 1000;
      ...
      public static const SCENE_FRAME_MAXIMUM:Number = 999999999;
      ...
      public static const SOUND_SNAP_INTERVAL:Number = 6;
      
      public static const SOUND_FRAME_INTERVAL:Number = 3;
      
      public static const SOUND_LENGTH_MINIMUM:Number = SCENE_LENGTH_MINIMUM;
      
      public static const SOUND_FRAME_MINIMUM:Number = 6;
      ...
      public static const MOVIE_THUMBNAIL_WIDTH:int = 150;
      
      public static const MOVIE_THUMBNAIL_HEIGHT:int = 97;
      
      public static const MOVIE_THUMBNAIL_LARGE_WIDTH:int = 380;
      
      public static const MOVIE_THUMBNAIL_LARGE_HEIGHT:int = 245;
      ...
      public static const SEARCH_ASSET_PAGE_SIZE:int = 20;
