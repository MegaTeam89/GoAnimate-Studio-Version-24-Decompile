package anifire.constant
{
   ...
   public class LicenseConstants
   {
      ...
      {
         var _loc1_:String = Util.getFlashVar().getValueByKey(ServerConstants.FLASHVAR_IS_WIDE) as String;
         if(_loc1_ == "true" || _loc1_ == "1")
         {
            return true;
         }
         return false;
      ...
      public static function get DONT_SHOW_COMMON_PROP_THEME_IDS() : Array
      {
         ...
         _loc1_.push("chowder");
         _loc1_.push("toonadv");
         _loc1_.push("business");
         _loc1_.push("anime");
         _loc1_.push("ninjaanime");
         _loc1_.push("sticklybiz");
