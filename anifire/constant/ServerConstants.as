package anifire.constant
{
   ...
   public class ServerConstants
   {
      ...
      public static const G4S_PATH:String = "http://goanimate4schools.com/";
      ...
      public static const ACTION_DELETE_TEMPLATE:String = get_server_path() + "DeleteUserTemplate/";
      ...
      public static const ACTION_SAVE_JPEG:String = get_server_path() + "jpg_download/screen.jpg";
      ...
      public static const ACTION_GET_PUBLICTEMPLATE:String = get_server_path() + "getSysTemplates/";
      
      public static const ACTION_GET_TEMPLATE_INFO:String = get_server_path() + "getSysTemplateAttributes/";
      
      public static const ACTION_UPDATE_TEMPLATE_INFO:String = get_server_path() + "updateSysTemplateAttributes/";
      ...
      public static const ACTION_GET_TTSVOICE:String = get_server_path() + "getTextToSpeechVoices/";
      
      public static const ACTION_GET_ASSET:String = get_server_path() + "getAsset/";
      
      public static const ACTION_REBUILD_TTS:String = get_server_path() + "rebuildTTS/";
      
      public static const ACTION_GET_WATERMARKS:String = get_server_path() + "getUserWatermarks/";
      
      public static const ACTION_ASSIGN_WATERMARK:String = get_server_path() + "assignwatermark/movie/";
      ...
      public static const BUSINESS_PAGE_PATH:String = HOST_PATH + "business";
      ...
      public static const ACTION_YOUTUBE_GOPLUS_SIGNUP:String = HOST_PATH + "/plussignup/";
      ...
      public static const FONT_PATH:String = HOST_PATH + "static/go/font/";
      ...
      public static function get_ACTION_SAVE_TEMPLATE(param1:int = -1) : String
      {
         if(param1 < 0)
         {
            return get_server_path() + "saveTemplate/";
         }
         return get_server_path(param1) + "saveTemplate/";
      }
      ...
      public static function get SERVER_PLAYER_PATH() : String
      {
         ...
         return URLUtil.getProtocol(FlexGlobals.topLevelApplication.url) + "://" + URLUtil.getServerNameWithPort(FlexGlobals.topLevelApplication.url) + "/movie/";
      }
      ...
      static function get_server_path(param1:int = -1) : String
      {
         ...
         var _loc3_:String = PARAM_APPCODE;
         var _loc4_:String = "fb";
         if(_loc2_.containsKey(_loc3_))
         {
            if(_loc2_.getValueByKey(_loc3_) as String != "")
            {
               _loc4_ = _loc2_.getValueByKey(_loc3_) as String;
            }
         }
         if(param1 < 0)
         {
            _loc5_ = _loc2_.getValueByKey(FLASHVAR_APISERVER) as String;
         }
         else
         {
            _loc5_ = "http://" + (get_contingency_web_server_array(_loc4_)[param1] as String) + "/";
         }
         try
         {
            _loc6_ = /:80/;
            _loc5_ = _loc5_.replace(_loc6_,"");
         }
         catch(e:Error)
         {
         }
         return _loc5_ + _loc4_ + "api/";
      }
      ...
      public static function get_contingency_web_server_array(param1:String = "go") : Array
      {
         ...
         if(IS_ON_PRODUCTION_SERVER)
         {
            if(param1 == "go")
            {
               _loc2_.push("web1.goanimate.com");
