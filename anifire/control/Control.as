package anifire.control
{
   ...
   public class Control extends Sprite
   {
      ...
      public function showControl(param1:Number = 1) : void
      {
         ...
         {
            Alert.show("Have\'t create control");
         }
      }
      ...
      {
         x += this._leftTopController_sp.x + this._offset;
         y += this._leftTopController_sp.y + this._offset;
         this._originX -= this._leftTopController_sp.x + this._offset;
         this._originY -= this._leftTopController_sp.y + this._offset;
         this.redraw();
      }
