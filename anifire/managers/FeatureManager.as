package anifire.managers
{
   ...
   public class FeatureManager
   {
      ...
      public static function get shouldIdeaButtonBeShown() : Boolean
      {
         return false;
      }
      ...
      {
         if(UtilSite.siteId == UtilSite.GOANIMATE || UtilSite.siteId == UtilSite.YOUTUBE || UtilSite.siteId == UtilSite.SKOLETUBE)
         {
            return true;
         }
         return false;
      ...
      {
         if(UtilSite.siteId == UtilSite.YOUTUBE || UtilSite.siteId == UtilSite.SCHOOL || UtilSite.siteId == UtilSite.SKOLETUBE)
         {
            return false;
         }
         return true;
      ...
      {
         if(UtilSite.siteId == UtilSite.SCHOOL || UtilSite.siteId == UtilSite.YOUTUBE || UtilSite.siteId == UtilSite.SKOLETUBE)
         {
            return false;
         }
         return true;
