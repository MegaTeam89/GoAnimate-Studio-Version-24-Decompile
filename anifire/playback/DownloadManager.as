package anifire.playback
{
   ...
   public class DownloadManager extends EventDispatcher
   {
      ...
      public function registerSoundChannel(param1:URLRequest, param2:Number, param3:Number, param4:ISoundAsset) : void
      {
         var _loc5_:String = null;
         _loc5_ = new Date().toString() + Math.random().toString();
         var _loc6_:ProgressiveSoundItem;
         (_loc6_ = new ProgressiveSoundItem()).init(param1,param2,param3,param4);
         this._sounds.push(_loc5_,_loc6_);
      }
...
class SoundItem extends EventDispatcher
{
...
class ProgressiveSoundItem extends SoundItem
{
   ...
   public function init(param1:URLRequest, param2:Number, param3:Number, param4:ISoundAsset) : void
   {
   ...
   public function destroy() : void
   {
      ...
      try
      {
         if(this._soundItem is ProgressiveSoundItem)
         {
            ...
            if(_loc1_.animeSound.sound.isBuffering)
            {
               _loc1_.animeSound.close();
            }
         }
      }
      catch(e:Error)
   ...
   public function stopService() : void
   {
      ...
      try
      {
         if(this._soundItem is ProgressiveSoundItem)
         {
            ...
            if(_loc1_ != null)
            {
               if(_loc1_.animeSound.sound.bytesLoaded < _loc1_.animeSound.sound.bytesTotal)
               {
                  _loc1_.animeSound.close();
               }
            }
