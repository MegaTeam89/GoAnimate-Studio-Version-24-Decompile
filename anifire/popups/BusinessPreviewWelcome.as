package anifire.popups
{
   ...
   public class BusinessPreviewWelcome extends Canvas implements IBindingClient
   {
      
      private static var _watcherSetupUtil:IWatcherSetupUtil2;
       
      
      public var _BusinessPreviewWelcome_Text1:Text;
      
      public var _BusinessPreviewWelcome_Text2:Text;
      
      public var _BusinessPreviewWelcome_Text3:Text;
      ...
      mx_internal var _BusinessPreviewWelcome_StylesInit_done:Boolean = false;
      ...
      public function BusinessPreviewWelcome()
      {
         var target:Object = null;
         var watcherSetupUtilClass:Object = null;
         this._documentDescriptor_ = new UIComponentDescriptor({
            "type":Canvas,
            "events":{"creationComplete":"___BusinessPreviewWelcome_Canvas1_creationComplete"},
                  ...
                  "propertiesFactory":function():Object
                  {
                     return {
                        ...
                        "childDescriptors":[new UIComponentDescriptor({
                           "type":Text,
                           "id":"_BusinessPreviewWelcome_Text1",
                           "stylesFactory":function():void
                           {
                              this.color = 16777215;
                              this.fontSize = 16;
                                 ...
                                 "childDescriptors":[new UIComponentDescriptor({
                                    ...
                                    "propertiesFactory":function():Object
                                    {
                                       return {
                                          ...
                                          "childDescriptors":[new UIComponentDescriptor({
                                             "type":Text,
                                             "id":"_BusinessPreviewWelcome_Text2",
                                             "stylesFactory":function():void
                                             {
                                                this.leading = 5;
                                                this.color = 6776679;
                                             ...
                                             "type":Text,
                                             "id":"_BusinessPreviewWelcome_Text3",
                                             "stylesFactory":function():void
                                             {
                                                this.leading = 7;
                                                this.color = 10066329;
         ...
         this._embed_mxml_image_char_png_930302995 = BusinessPreviewWelcome__embed_mxml_image_char_png_930302995;
         this._bindings = [];
         this._watchers = [];
         ...
         var bindings:Array = this._BusinessPreviewWelcome_bindingsSetup();
         var watchers:Array = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_anifire_popups_BusinessPreviewWelcomeWatcherSetupUtil");
         ...
         {
            return BusinessPreviewWelcome[param1];
         },bindings,watchers);
         ...
         this._BusinessPreviewWelcome_DropShadowFilter1_i();
         this.addEventListener("creationComplete",this.___BusinessPreviewWelcome_Canvas1_creationComplete);
         var i:uint = 0;
      ...
      {
         BusinessPreviewWelcome._watcherSetupUtil = param1;
      }
      ...
      override public function set moduleFactory(param1:IFlexModuleFactory) : void
      {
         ...
         mx_internal::_BusinessPreviewWelcome_StylesInit();
      }
      ...
      private function _BusinessPreviewWelcome_DropShadowFilter1_i() : DropShadowFilter
      {
      ...
      public function ___BusinessPreviewWelcome_Canvas1_creationComplete(param1:FlexEvent) : void
      {
         this.init();
      }
      ...
      private function _BusinessPreviewWelcome_bindingsSetup() : Array
      {
         var result:Array = [];
         result[0] = new Binding(this,function():String
         {
            var _loc1_:* = UtilDict.toDisplay("go","Welcome");
            return _loc1_ == undefined ? null : String(_loc1_);
         },null,"_BusinessPreviewWelcome_Text1.text");
         result[1] = new Binding(this,function():String
         {
            var _loc1_:* = UtilDict.toDisplay("go","Welcome to the GoAnimate Business Account Preview");
            return _loc1_ == undefined ? null : String(_loc1_);
         },null,"_BusinessPreviewWelcome_Text2.text");
         result[2] = new Binding(this,function():String
         {
            var _loc1_:* = UtilDict.toDisplay("go","In this preview, you can practice using our Business Friendly, Stickly Business and other Video Makers reserved for business accounts only.  To switch between the Video Makers, use the drop down control on the top left of the screen. Please note videos made in this preview environment cannot be saved.");
            return _loc1_ == undefined ? null : String(_loc1_);
         },null,"_BusinessPreviewWelcome_Text3.text");
         result[3] = new Binding(this,function():String
         {
            var _loc1_:* = UtilDict.toDisplay("go","Get Started >");
            return _loc1_ == undefined ? null : String(_loc1_);
         },null,"_btnOk.label");
         return result;
      }
      
      mx_internal function _BusinessPreviewWelcome_StylesInit() : void
      {
         var style:CSSStyleDeclaration = null;
         var effects:Array = null;
         if(mx_internal::_BusinessPreviewWelcome_StylesInit_done)
         {
            return;
         }
         mx_internal::_BusinessPreviewWelcome_StylesInit_done = true;
