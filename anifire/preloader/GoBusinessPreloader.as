...
{
   import anifire.banner.GoBusinessBanner;
   ...
   public class GoBusinessPreloader extends Sprite implements IPreloaderDisplay
   {
      ...
      public function GoBusinessPreloader()
      {
         super();
         this.visible = false;
      }
      ...
      public function set preloader(param1:Sprite) : void
      {
         ...
         var banner:GoBusinessBanner = new GoBusinessBanner();
         banner.init(tlang);
