...
{
   import anifire.banner.GoPlusBanner;
   ...
   public class GoPlusPreloader extends Sprite implements IPreloaderDisplay
   {
      ...
      public function GoPlusPreloader()
      {
         super();
         this.visible = false;
      }
      ...
      public function set preloader(param1:Sprite) : void
      {
         ...
         var banner:GoPlusBanner = new GoPlusBanner();
         banner.init(tlang);
