package anifire.timeline
{
   ...
   public class TimelineHScrollBar extends HScrollBar
   {
      ...
      private function onEnterFrame(param1:Event) : void
      {
         ...
         this.scrollPosition -= this.momentum;
      ...
      override public function set visible(param1:Boolean) : void
      {
         ...
         if(param1 == true)
         {
            if(this._currContainer is SceneContainer && this._changeType != "Resize")
            {
               ...
               {
                  _loc2_ += this._currContainer.getItemAt(_loc3_).width;
                  _loc3_++;
               }
      ...
      private function setContainerView(param1:Event) : void
      {
         ...
         if(this.visible && _loc2_ > _loc3_)
         {
            ...
            {
               if(this._conatainerArr.getItemAt(_loc5_).Container is SceneContainer)
               {
            ...
            Console.getConsole().timeline.scroll(_loc4_);
         }
         else
         {
            this.visible = false;
            Console.getConsole().timeline.scroll(0);
         }
      }
      ...
      private function getChildTotalWidth(param1:ITimelineContainer) : Number
      {
         ...
         else if(param1 is SceneContainer)
         {
            ...
            {
               _loc2_ += _loc4_.itemList_hb.getChildAt(_loc5_).width;
               _loc5_++;
            }
            _loc2_ += this.EXTRA_SPACE_AT_END;
         }
         return _loc2_;
      }
