      ...
      public function BasicTutorial()
      {
         ...
         _data = <tutorial>
				...
				<step>
					...
					<uncover>
						<rect x="10" y="101" w="274" h="350"/>
						<rect x="356" y="48" w="553" h="355"/>
					</uncover>	
					<focus x="184" y="253"/>
					<guide visible="false" action="talk01" facial="head_talk_happy"/>
				...
				<step>
					<message x="{MESSAGE_BOX_X_DEFAULT}" y="{MESSAGE_BOX_Y_DEFAULT}">
						{"Great! The voice has been updated. This is looking like the beginning of a cool video. It\'s time to preview what we have done so far."}
					</message>
					<uncover>
					</uncover>	
					<guide visible="true" action="talk01" facial="head_talk_happy"/>
