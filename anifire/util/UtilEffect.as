package anifire.util
{
   ...
   public class UtilEffect
   {
      ...
      public static function insertLabels(param1:UtilHashArray) : void
      {
         ...
         param1.push("FESZoomBlur","Blur - zooming");
