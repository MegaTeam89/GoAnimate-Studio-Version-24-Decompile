package anifire.util
{
   ...
   public class UtilUnitConvert
   {
      ...
      {
         return Math.round(param1 * AnimeConstants.FRAME_PER_PIXEL) + 1;
      }
      ...
      public static function frameToTime(param1:int, param2:Boolean = true) : Number
      {
         if(param1 > 0)
         {
            if(param2)
      ...
      public static function frameToDuration(param1:int) : Number
      {
         return param1 / AnimeConstants.FRAME_PER_SEC;
      }
      ...
      public static function frameToX(param1:Number) : Number
      {
      ...
      {
         return Math.round(param1 / AnimeConstants.SOUND_SNAP_INTERVAL) * AnimeConstants.SOUND_SNAP_INTERVAL;
      }
