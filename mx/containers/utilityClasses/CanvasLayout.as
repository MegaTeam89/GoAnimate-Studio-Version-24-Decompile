package mx.containers.utilityClasses
{
   ...
   public class CanvasLayout extends Layout
   {
      ...
      override public function measure() : void
      {
         ...
         {
            if((_loc8_ = IConstraintLayout(_loc1_).constraintColumns[_loc4_]).contentSize)
            {
               _loc8_._width = NaN;
            }
            _loc4_++;
         ...
         {
            if((_loc9_ = IConstraintLayout(_loc1_).constraintRows[_loc4_]).contentSize)
            {
               _loc9_._height = NaN;
            }
            _loc4_++;
      ...
      override public function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         if(this.constraintRegionsInUse)
         {
            ...
            {
               if((_loc10_ = IConstraintLayout(_loc5_).constraintColumns[_loc3_]).contentSize)
               {
                  _loc10_._width = NaN;
               }
               _loc3_++;
            ...
            {
               if((_loc11_ = IConstraintLayout(_loc5_).constraintRows[_loc3_]).contentSize)
               {
                  _loc11_._height = NaN;
               }
               _loc3_++;
      ...
      private function applyAnchorStylesDuringMeasure(param1:IUIComponent, param2:Rectangle) : void
      {
         ...
         if(!(_loc4_ = this.constraintCache[_loc3_]))
         {
      ...
      private function applyAnchorStylesDuringUpdateDisplayList(param1:Number, param2:Number, param3:IUIComponent = null) : void
      {
         ...
         var _loc6_:Number = (_loc5_ = this.parseConstraints(param3)).left;
      ...
      private function parseConstraints(param1:IUIComponent = null) : ChildConstraintInfo
      {
         ...
         if(!(_loc17_ = this.parseConstraintExp(_loc2_.left)))
         {
            _loc3_ = NaN;
         }
         ...
         if(!(_loc17_ = this.parseConstraintExp(_loc2_.right)))
         {
            _loc4_ = NaN;
         }
         else if(_loc17_.length == 1)
         ...
         if(!(_loc17_ = this.parseConstraintExp(_loc2_.horizontalCenter)))
         {
            _loc5_ = NaN;
         }
         else if(_loc17_.length == 1)
         ...
         if(!(_loc17_ = this.parseConstraintExp(_loc2_.top)))
         {
            _loc6_ = NaN;
         }
         else if(_loc17_.length == 1)
         ...
         if(!(_loc17_ = this.parseConstraintExp(_loc2_.bottom)))
         {
            _loc7_ = NaN;
         }
         else if(_loc17_.length == 1)
         ...
         if(!(_loc17_ = this.parseConstraintExp(_loc2_.verticalCenter)))
         {
            _loc8_ = NaN;
         }
         else if(_loc17_.length == 1)
         ...
         if(!(_loc17_ = this.parseConstraintExp(_loc2_.baseline)))
         {
            _loc9_ = NaN;
         }
         else if(_loc17_.length == 1)
         ...
         {
            if((_loc30_ = IConstraintLayout(target).constraintColumns[_loc18_]).contentSize)
            {
         ...
         {
            if((_loc32_ = IConstraintLayout(target).constraintRows[_loc18_]).contentSize)
            {
         ...
         if(_loc1_.length > 0)
         {
            ...
            if(_loc12_.length > 0)
            {
               if(this.colSpanChildren.length > 0)
               {
                  ...
                  {
                     if((_loc19_ = this.colSpanChildren[_loc4_]).span == 1)
                     {
                        if(_loc19_.hcCol)
                        {
         ...
         if(_loc2_.length > 0)
         {
            ...
            if(_loc12_.length > 0)
            {
               if(this.rowSpanChildren.length > 0)
               {
                  ...
                  {
                     if((_loc20_ = this.rowSpanChildren[_loc4_]).span == 1)
                     {
                        if(_loc20_.vcRow)
                        {
      ...
      private function shareColumnSpace(param1:ContentColumnChild, param2:Number) : Number
      {
         ...
         {
            if((_loc4_ = IConstraintLayout(target).constraintColumns[param1.left + 1]) && _loc4_.width)
            {
               _loc7_ += _loc4_.width;
            }
         }
         ...
         var _loc10_:Number;
         if(_loc10_ = _loc5_.getExplicitOrMeasuredWidth())
         {
            if(!param1.leftCol)
            {
               if(_loc10_ > _loc6_)
      ...
      private function shareRowSpace(param1:ContentRowChild, param2:Number) : Number
      {
         ...
         {
            if((_loc4_ = IConstraintLayout(target).constraintRows[param1.top + 1]) && _loc4_.height)
            {
               _loc7_ += _loc4_.height;
            }
         }
         ...
         var _loc10_:Number;
         if(_loc10_ = _loc5_.getExplicitOrMeasuredHeight())
         {
            if(!param1.topRow)
            {
               if(_loc10_ > _loc6_)
