package mx.core
{
   ...
   public class LayoutElementUIComponentUtils
   {
      ...
      private static function getPreferredUBoundsWidth(param1:IUIComponent) : Number
      {
         ...
         {
            _loc2_ = param1.scaleX == 0 ? Number(0) : Number(_loc2_ / param1.scaleX);
         }
         return _loc2_;
      }
      ...
      private static function getPreferredUBoundsHeight(param1:IUIComponent) : Number
      {
         ...
         if(FlexVersion.compatibilityVersion < FlexVersion.VERSION_4_0)
         {
            _loc2_ = param1.scaleY == 0 ? Number(0) : Number(_loc2_ / param1.scaleY);
         }
         return _loc2_;
      }
      ...
      private static function getMinUBoundsWidth(param1:IUIComponent) : Number
      {
         ...
         {
            _loc2_ = !!isNaN(param1.measuredMinWidth) ? Number(0) : Number(param1.measuredMinWidth);
      ...
      private static function getMinUBoundsHeight(param1:IUIComponent) : Number
      {
         ...
         {
            _loc2_ = !!isNaN(param1.measuredMinHeight) ? Number(0) : Number(param1.measuredMinHeight);
      ...
      public static function getLayoutBoundsWidth(param1:IUIComponent, param2:Matrix) : Number
      {
         ...
         if(FlexVersion.compatibilityVersion < FlexVersion.VERSION_4_0)
         {
            _loc3_ = param1.scaleX == 0 ? Number(0) : Number(_loc3_ / param1.scaleX);
         }
         if(param2)
         {
            ...
            if(FlexVersion.compatibilityVersion < FlexVersion.VERSION_4_0)
            {
               _loc4_ = param1.scaleY == 0 ? Number(0) : Number(_loc4_ / param1.scaleY);
            }
      ...
      public static function getLayoutBoundsHeight(param1:IUIComponent, param2:Matrix) : Number
      {
         ...
         if(FlexVersion.compatibilityVersion < FlexVersion.VERSION_4_0)
         {
            _loc3_ = param1.scaleY == 0 ? Number(0) : Number(_loc3_ / param1.scaleY);
         }
         if(param2)
         {
            _loc4_ = param1.width;
            if(FlexVersion.compatibilityVersion < FlexVersion.VERSION_4_0)
            {
               _loc4_ = param1.scaleX == 0 ? Number(0) : Number(_loc4_ / param1.scaleX);
            }
