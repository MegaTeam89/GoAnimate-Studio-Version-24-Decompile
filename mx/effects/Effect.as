package mx.effects
{
   ...
   public class Effect extends EventDispatcher implements IEffect
   {
      ...
      mx_internal function captureValues(param1:Array, param2:Boolean, param3:Array = null) : Array
      {
         ...
         var _loc6_:Array;
         if((_loc6_ = !this.filterObject ? this.relevantProperties : mergeArrays(this.relevantProperties,this.filterObject.filterProperties)) && _loc6_.length > 0)
         {
         ...
         var _loc11_:Array;
         if((_loc11_ = !this.filterObject ? this.relevantStyles : mergeArrays(this.relevantStyles,this.filterObject.filterStyles)) && _loc11_.length > 0)
         {
            _loc4_ = param1.length;
            _loc5_ = 0;
            while(_loc5_ < _loc4_)
