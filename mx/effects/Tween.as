package mx.effects
{
   ...
   public class Tween extends EventDispatcher
   {
      ...
      private static function addTween(param1:Tween) : void
      {
         ...
         param1.startTime = param1.previousUpdateTime = mx_internal::intervalTime;
      }
      ...
      private static function removeTweenAt(param1:int) : void
      {
         ...
         var _loc2_:int = mx_internal::activeTweens.length;
      ...
      private static function timerHandler(param1:TimerEvent) : void
      {
         ...
         intervalTime = getTimer();
         var _loc4_:int;
         var _loc5_:int = _loc4_ = mx_internal::activeTweens.length;
         while(_loc5_ >= 0)
         {
      ...
      mx_internal function doInterval() : Boolean
      {
         ...
         {
            _loc2_ = mx_internal::intervalTime - this.startTime;
      ...
      public function resume() : void
      {
         ...
         this.startTime = mx_internal::intervalTime - this._playheadTime;
         if(this._doReverse)
         {
            this.reverse();
            this._doReverse = false;
