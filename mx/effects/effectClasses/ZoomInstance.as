      ...
      private function applyPropertyChanges() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc1_.end["scaleX"] !== undefined)
            {
               ...
               this.zoomWidthTo = !!isNaN(this.zoomWidthTo) ? Number(_loc1_.end["scaleX"]) : Number(this.zoomWidthTo);
               _loc3_ = true;
            }
            if(_loc1_.end["scaleY"] !== undefined)
            {
               ...
               this.zoomHeightTo = !!isNaN(this.zoomHeightTo) ? Number(_loc1_.end["scaleY"]) : Number(this.zoomHeightTo);
               _loc3_ = true;
            }
            if(_loc3_)
            {
            ...
            if(_loc1_.end["width"] !== undefined)
            {
               ...
               this.zoomWidthTo = !!isNaN(this.zoomWidthTo) ? Number(this.getScaleFromWidth(_loc1_.end["width"])) : Number(this.zoomWidthTo);
               _loc2_ = true;
            }
            if(_loc1_.end["height"] !== undefined)
            {
               ...
               this.zoomHeightTo = !!isNaN(this.zoomHeightTo) ? Number(this.getScaleFromHeight(_loc1_.end["height"])) : Number(this.zoomHeightTo);
               _loc2_ = true;
            }
            if(_loc2_)
            {
