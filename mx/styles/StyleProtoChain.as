package mx.styles
{
   ...
   public class StyleProtoChain
   {
      ...
      public static function getClassStyleDeclarations(param1:IStyleClient) : Array
      {
         ...
         var _loc8_:int = (_loc7_ = (_loc6_ = getTypeHierarchy(param1,_loc3_)).propertyList).length;
      ...
      public static function initProtoChain(param1:IStyleClient, param2:Boolean = true) : void
      {
         ...
         var _loc12_:Object;
         if((_loc12_ = _loc3_.stylesRoot) && _loc12_.effects)
         {
         ...
         {
            _loc4_ = (_loc14_ = getMatchingStyleDeclarations(_loc7_,_loc9_)) != null ? int(_loc14_.length) : 0;
            _loc5_ = 0;
            while(_loc5_ < _loc4_)
            {
               _loc15_ = (_loc8_ = _loc14_[_loc5_]).addStyleToProtoChain(_loc15_,_loc6_);
         ...
         else
         {
            ...
            _loc4_ = (_loc14_ = param1.getClassStyleDeclarations()) != null ? int(_loc14_.length) : 0;
            _loc5_ = 0;
            while(_loc5_ < _loc4_)
            {
               _loc15_ = (_loc8_ = _loc14_[_loc5_]).addStyleToProtoChain(_loc15_,_loc6_);
      ...
      public static function initProtoChainForUIComponentStyleName(param1:IStyleClient) : void
      {
         ...
         while(_loc9_ < _loc8_)
         {
            _loc6_ = (_loc10_ = _loc7_[_loc9_]).addStyleToProtoChain(_loc6_,_loc4_);
      ...
      private static function addProperties(param1:Object, param2:IStyleClient, param3:Boolean) : Object
      {
         ...
         else
         {
            ...
            {
               param1 = (_loc10_ = _loc9_[_loc13_]).addStyleToProtoChain(param1,_loc6_,_loc4_);
               if(_loc10_.effects)
               {
                  param2.registerEffects(_loc10_.effects);
               }
      ...
      public static function matchesCSSType(param1:IAdvancedStyleClient, param2:String) : Boolean
      {
         ...
         return (_loc5_ = getTypeHierarchy(param1,_loc4_)).getObjectProperty(param2) != null;
      }
