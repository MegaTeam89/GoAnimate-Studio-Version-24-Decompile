package mx.utils
{
   ...
   public final class MatrixUtil
   {
      ...
      public static function fitBounds(param1:Number, param2:Number, param3:Matrix, param4:Number, param5:Number, param6:Number, param7:Number, param8:Number, param9:Number, param10:Number, param11:Number) : Point
      {
         ...
         var _loc12_:Number = param8 < mx_internal::MIN_MAX_TOLERANCE ? Number(0) : Number(param8 - mx_internal::MIN_MAX_TOLERANCE);
         var _loc13_:Number = param9 < mx_internal::MIN_MAX_TOLERANCE ? Number(0) : Number(param9 - mx_internal::MIN_MAX_TOLERANCE);
         ...
         if(!isNaN(param1) && !isNaN(param2))
         {
            if(!(_loc16_ = calcUBoundsToFitTBounds(param1,param2,param3,_loc12_,_loc13_,_loc14_,_loc15_)))
            {
               ...
               if(_loc17_ && _loc18_)
               {
                  _loc16_ = _loc17_.x * _loc17_.y > _loc18_.x * _loc18_.y ? _loc17_ : _loc18_;
               }
               else if(_loc17_)
               {
                  _loc16_ = _loc17_;
      ...
      public static function calcUBoundsToFitTBoundsHeight(param1:Number, param2:Matrix, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number, param8:Number) : Point
      {
         ...
         var _loc11_:Number;
         if((_loc11_ = _loc9_ * _loc10_ >= 0 ? Number(_loc10_) : Number(-_loc10_)) != 0 && param3 > 0)
         {
            _loc18_ = 1 / _loc11_;
         ...
         _loc15_ = param2.a;
         _loc16_ = param2.c;
         var _loc17_:Number = _loc15_ * _loc16_ >= 0 ? Number(_loc16_) : Number(-_loc16_);
      ...
      public static function calcUBoundsToFitTBounds(param1:Number, param2:Number, param3:Matrix, param4:Number, param5:Number, param6:Number, param7:Number) : Point
      {
         ...
         var _loc12_:Number = _loc8_ * _loc10_ >= 0 ? Number(_loc10_) : Number(-_loc10_);
         var _loc13_:Number = _loc9_ * _loc11_ >= 0 ? Number(_loc11_) : Number(-_loc11_);
      ...
      public static function isEqual3D(param1:Matrix3D, param2:Matrix3D) : Boolean
      {
         ...
         if(param1 && param2 && param1.rawData.length == param2.rawData.length)
         {
      ...
      private static function getConcatenatedMatrixHelper(param1:DisplayObject, param2:Boolean, param3:DisplayObject) : Matrix
      {
         ...
         while(param1 && param1.transform.matrix && param1 != param3)
         {
            ...
            if(usesMarshalling && "moduleFactory" in param1)
            {
               if((_loc8_ = param1["moduleFactory"]) && _loc8_ !== lastModuleFactory && "info" in _loc8_)
               {
                  if((_loc9_ = _loc8_["info"]()["currentDomain"]) && _loc9_.hasDefinition("mx.core.UIComponent"))
                  {
                     uiComponentClass = Class(_loc9_.getDefinition("mx.core.UIComponent"));
                  }
                  if(_loc9_ && _loc9_.hasDefinition("mx.flash.UIMovieClip"))
                  {
            ...
            _loc6_ = uiComponentClass && param1 is uiComponentClass;
            _loc7_ = uiMovieClipClass && param1 is uiMovieClipClass;
            if(param2 && _loc6_)
            {
